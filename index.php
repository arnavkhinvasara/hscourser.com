...
$pos_pages = array("/about", "/contact", "/privacy", "/terms", "/register", "/login", "/dashboard", "/forgotpassword", "/logout", "/schedule", "/deleteschedule", "/addfriends", "/changename", "/viewfriends", "/deleteaccount", "/changeschool");
